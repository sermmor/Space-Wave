...
APlayerMissileProjectile::APlayerMissileProjectile()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ProjectileMeshAsset(TEXT("/Game/SpaceWave/Meshes/PlayerMissileProjectile.PlayerMissileProjectile"));
